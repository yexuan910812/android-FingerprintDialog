...
public final class FingerprintModule$$ModuleAdapter extends ModuleAdapter<FingerprintModule> {
  ...
  public void getBindings(BindingsGroup bindings, FingerprintModule module) {
    ...
    bindings.contributeProvidesBinding("java.security.KeyPairGenerator", new ProvidesKeyGeneratorProvidesAdapter(module));
    bindings.contributeProvidesBinding("java.security.Signature", new ProvidesCipherProvidesAdapter(module));
   ...
   * preparation of object instances.
   */
  public static final class ProvidesKeyGeneratorProvidesAdapter extends ProvidesBinding<java.security.KeyPairGenerator>
      implements Provider<java.security.KeyPairGenerator> {
    private final FingerprintModule module;

    public ProvidesKeyGeneratorProvidesAdapter(FingerprintModule module) {
      super("java.security.KeyPairGenerator", NOT_SINGLETON, "com.example.android.fingerprintdialog.FingerprintModule", "providesKeyGenerator");
      this.module = module;
      setLibrary(true);
    }
   ...
   * preparation of object instances.
   */
  public static final class ProvidesCipherProvidesAdapter extends ProvidesBinding<java.security.Signature>
    ...
    public ProvidesCipherProvidesAdapter(FingerprintModule module) {
      super("java.security.Signature", NOT_SINGLETON, "com.example.android.fingerprintdialog.FingerprintModule", "providesCipher");
      this.module = module;
      setLibrary(true);
    }
